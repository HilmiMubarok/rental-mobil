...
<html lang="en">
  ...
  <head>
    ...
    <title>Joko Trans Rental | Login</title>
          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="fleet.html">Profil</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="offers.html">Pemesanan</a>
              </li>
                ...
                <div class="down-content">
                  ...
                  <div class="post-options">
                    <div class="row">
                      <div class="col-lg-12">
                        <ul class="post-tags">
                          <li><a href="#" class="btn btn-primary text-white">Book Now</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
