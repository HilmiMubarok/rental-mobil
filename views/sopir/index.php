							...
							<div class="card-body">
								<form method="POST" action="<?= base_url('sopir/tambah') ?>" enctype="multipart/form-data">
								  	<div class="form-group">
										...
										<input type="text" id="nama" name="nama_sopir" class="form-control" required placeholder="Nama Sopir" autocomplete="off">
								  	</div>
								  	<div class="form-group">
								  		<label for="hp">Nomor HP</label>
								  		<input type="text" name="nomor_hp" id="hp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
								  		<label for="hp">Foto</label>
								  		<input type="file" name="foto" id="hp" required="required" placeholder="ketik" autocomplete="off" class="form-control">
								  	</div>
								  	<div class="form-group">
						...
						<div class="card shadow">
							...
							<div class="card-body">
								...
								<table class="table table-bordered" id="dataTable" cellspacing="0">
	                 				...
	                 				<tbody>
										<?php while($sopir = $data_sopir->fetch_object()) : ?>
											<tr>
												...
												<td>
													<a href="<?= base_url('sopir/ubah/' . $sopir->id) ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
													<a href="<?= base_url('sopir/detail/' . $sopir->id) ?>" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i> Detail</a>
	                 								<a href="<?= base_url('sopir/hapus/' . $sopir->id) ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
												</td>
											</tr>
										<?php endwhile; ?>
	                 				</tbody>
